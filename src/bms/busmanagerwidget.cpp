...
void BusManagerWidget::createWidgets()
{
    ...
    _toolBar = new QToolBar(tr("Bus command"));
    ...
    iconConnect.addFile(":/icons/img/icons8-connected.png",QSize(),QIcon::Normal, QIcon::Off);
    _actionTogleConnect->setIcon(iconConnect);
    _actionTogleConnect->setChecked(true);
    ...
    connect(_syncTimerSpinBox,&QSpinBox::editingFinished,this,[=](){setSyncTimer(_syncTimerSpinBox->value());});
