...
BMS_DataLogger::BMS_DataLogger(QObject *parent)
    : QObject(parent)
{
...
BMS_DataLogger::~BMS_DataLogger()
{
    removeAllData();
}

bool BMS_DataLogger::isStarted() const
{
    return _timer.isActive();
}

void BMS_DataLogger::addData(const NodeObjectId &objId)
{
...
void BMS_DataLogger::addData(const QList<NodeObjectId> &objIds)
{
...
void BMS_DataLogger::removeData(const NodeObjectId &objId)
{
...
void BMS_DataLogger::removeAllData()
{
