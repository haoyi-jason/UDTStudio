...
#ifndef BMS_CANFRAMEMODEL_H
#define BMS_CANFRAMEMODEL_H
...
class BMS_CanFrameModel : public QAbstractItemModel
{
    Q_OBJECT
public:
    BMS_CanFrameModel(QObject *parent = nullptr);
    ~BMS_CanFrameModel() override;
