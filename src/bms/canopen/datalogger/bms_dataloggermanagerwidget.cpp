...
BMS_DataLoggerManagerWidget::BMS_DataLoggerManagerWidget(DataLogger *logger, QWidget *parent)
    : QWidget(parent)
    , _logger(logger)
{
    createWidgets();
...
void BMS_DataLoggerManagerWidget::toggleStartLogger(bool start)
{
    if (start)
    {
...
void BMS_DataLoggerManagerWidget::setLogTimerMs(int ms)
{
...
void BMS_DataLoggerManagerWidget::setUseOpenGL(bool useOpenGL)
{
...
void BMS_DataLoggerManagerWidget::setViewCross(bool viewCross)
{
    if (_chartWidget != nullptr)
    {
...
void BMS_DataLoggerManagerWidget::setRollingEnabled(bool enabled)
{
    if (_chartWidget != nullptr)
    {
...
void BMS_DataLoggerManagerWidget::setRollingTimeMs(int ms)
{
    if (_chartWidget != nullptr)
    {
...
void BMS_DataLoggerManagerWidget::takeScreenShot()
{
    if (_chartWidget == nullptr)
    {
        return;
...
void BMS_DataLoggerManagerWidget::exportAllCSVData()
{
    if (_logger == nullptr)
    {
        return;
...
BMS_DataLoggerChartsWidget *BMS_DataLoggerManagerWidget::chartWidget() const
{
    return _chartWidget;
}

void BMS_DataLoggerManagerWidget::setChartWidget(BMS_DataLoggerChartsWidget *chartWidget)
{
    _chartWidget = chartWidget;

    connect(_chartWidget,
            &BMS_DataLoggerChartsWidget::useOpenGLChanged,
            this,
            [=](bool changed)
            {
    ...
    connect(_chartWidget,
            &BMS_DataLoggerChartsWidget::viewCrossChanged,
            this,
            [=](bool changed)
            {
    ...
    connect(_chartWidget,
            &BMS_DataLoggerChartsWidget::rollingChanged,
            this,
            [=](bool changed)
            {
    ...
    connect(_chartWidget,
            &BMS_DataLoggerChartsWidget::rollingTimeMsChanged,
            this,
            [=](int timeMs)
            {
...
void BMS_DataLoggerManagerWidget::createWidgets()
{
    QAction *action;
    ...
    connect(_startStopAction, &QAction::triggered, this, &BMS_DataLoggerManagerWidget::toggleStartLogger);
    connect(_logger,
            &BMS_DataLogger::startChanged,
            this,
            [=](bool changed)
            {
    ...
    connect(action, &QAction::triggered, _logger, &BMS_DataLogger::clear);
    ...
    connect(_openGLAction, &QAction::triggered, this, &BMS_DataLoggerManagerWidget::setUseOpenGL);
    ...
    connect(_crossAction, &QAction::triggered, this, &BMS_DataLoggerManagerWidget::setViewCross);
    ...
    connect(_rollAction, &QAction::triggered, this, &BMS_DataLoggerManagerWidget::setRollingEnabled);
    ...
    connect(_exportCSVAction, &QAction::triggered, this, &BMS_DataLoggerManagerWidget::exportAllCSVData);
    ...
    connect(_screenShotAction, &QAction::triggered, this, &BMS_DataLoggerManagerWidget::takeScreenShot);
...
QAction *BMS_DataLoggerManagerWidget::startStopAction() const
{
