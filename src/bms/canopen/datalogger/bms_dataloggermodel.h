...
#ifndef BMS_DATALOGGERMODEL_H
#define BMS_DATALOGGERMODEL_H
...
class BMS_DataLoggerModel : public QAbstractItemModel
{
    Q_OBJECT
public:
    BMS_DataLoggerModel(QObject *parent = nullptr);
    ~BMS_DataLoggerModel() override;

    BMS_DataLogger *dataLogger() const;
    void setDataLogger(BMS_DataLogger *dataLogger);
