...
BMS_DataLoggerChartsWidget::BMS_DataLoggerChartsWidget(QWidget *parent)
    : BMS_DataLoggerChartsWidget(nullptr, parent)
{
}

BMS_DataLoggerChartsWidget::BMS_DataLoggerChartsWidget(DataLogger *dataLogger, QWidget *parent)
    : QChartView(parent)
{
    _dataLogger = nullptr;
...
BMS_DataLoggerChartsWidget::~BMS_DataLoggerChartsWidget()
{
    delete _chart;
}

BMS_DataLogger *BMS_DataLoggerChartsWidget::dataLogger() const
{
    return _dataLogger;
}

void BMS_DataLoggerChartsWidget::setDataLogger(DataLogger *dataLogger)
{
    if (dataLogger != _dataLogger)
    {
        if (dataLogger != nullptr)
        {
            connect(dataLogger, &DataLogger::dataAboutToBeAdded, this, &BMS_DataLoggerChartsWidget::addDataPrepare);
            connect(dataLogger, &DataLogger::dataAdded, this, &BMS_DataLoggerChartsWidget::addDataOk);
            connect(dataLogger, &DataLogger::dataAboutToBeRemoved, this, &BMS_DataLoggerChartsWidget::removeDataPrepare);
            connect(dataLogger, &DataLogger::dataRemoved, this, &BMS_DataLoggerChartsWidget::removeDataOk);
        }
    }
    _dataLogger = dataLogger;
}

QChart *BMS_DataLoggerChartsWidget::chart() const
{
    return _chart;
}

QList<QXYSeries *> BMS_DataLoggerChartsWidget::series() const
{
    return _series;
}

bool BMS_DataLoggerChartsWidget::useOpenGL() const
{
    return _useOpenGL;
}

void BMS_DataLoggerChartsWidget::setUseOpenGL(bool useOpenGL)
{
...
bool BMS_DataLoggerChartsWidget::viewCross() const
{
    return _viewCross;
}

void BMS_DataLoggerChartsWidget::setViewCross(bool viewCross)
{
...
bool BMS_DataLoggerChartsWidget::isRollingEnabled() const
{
    return _rollingEnabled;
}

void BMS_DataLoggerChartsWidget::setRollingEnabled(bool rollingEnabled)
{
...
int BMS_DataLoggerChartsWidget::rollingTimeMs() const
{
    return _rollingTimeMs;
}

void BMS_DataLoggerChartsWidget::setRollingTimeMs(int rollingTimeMs)
{
...
void BMS_DataLoggerChartsWidget::updateDlData(int id)
{
    if (id >= _series.count())
    {
        return;
...
void BMS_DataLoggerChartsWidget::addDataPrepare(int id)
{
    _idPending = id;
}

void BMS_DataLoggerChartsWidget::addDataOk()
{
    if (_idPending >= 0 && _idPending < _dataLogger->dataList().count())
    {
        ...
        connect(serie, &QLineSeries::hovered, this, &BMS_DataLoggerChartsWidget::tooltip);
    }
    _idPending = -1;
}

void BMS_DataLoggerChartsWidget::removeDataPrepare(int id)
{
...
void BMS_DataLoggerChartsWidget::removeDataOk()
{
    _idPending = -1;
}

void BMS_DataLoggerChartsWidget::updateYaxis()
{
...
void BMS_DataLoggerChartsWidget::tooltip(QPointF point, bool state)
{
    Q_UNUSED(state)
...
void BMS_DataLoggerChartsWidget::updateSeries()
{
...
void BMS_DataLoggerChartsWidget::dropEvent(QDropEvent *event)
{
...
void BMS_DataLoggerChartsWidget::dragEnterEvent(QDragEnterEvent *event)
{
...
void BMS_DataLoggerChartsWidget::dragMoveEvent(QDragMoveEvent *event)
{
